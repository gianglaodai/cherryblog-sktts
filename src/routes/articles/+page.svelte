...
<div class="articles">
	...
	<!-- Article 2 -->
	<article class="prose prose-lg dark:prose-invert prose-a:text-blue-500 mb-12 max-w-full">
		<RichTextViewer value={value2} />
		<Button variant="default" onclick={goto('/articles/slug-content')}>READ MORE</Button>
